      ...
      return (
        ...
        (e.prototype.formatRange = function (e, t, n, r) {
          return (
            ...
            n.formatRange({ marker: e, timeZoneOffset: null != r.forcedStartTzo ? r.forcedStartTzo : this.offsetForMarker(e) }, { marker: t, timeZoneOffset: null != r.forcedEndTzo ? r.forcedEndTzo : this.offsetForMarker(t) }, this)
          );
        }),
    ...
    return (
      ...
      (e.prototype.buildDateSpanApi = function (e) {
        ...
        return (
          Se(
            r,
            ((t = e), { start: (n = this.dateEnv).toDate(t.range.start), end: n.toDate(t.range.end), startStr: n.formatIso(t.range.start, { omitTime: t.allDay }), endStr: n.formatIso(t.range.end, { omitTime: t.allDay }), allDay: t.allDay })
          ),
          r
        );
      }),
  ...
  var Nr = (function () {
    ...
    return (
      ...
      (e.prototype._getTimeText = function (e, t, n, r, i, o, a) {
        ...
        return (
          null == r && (r = this.eventTimeFormat), null == i && (i = this.displayEventEnd), this.displayEventTime && !n ? (i && t ? s.formatRange(e, t, r, { forcedStartTzo: o, forcedEndTzo: a }) : s.format(e, r, { forcedTzo: o })) : ""
        );
      }),
